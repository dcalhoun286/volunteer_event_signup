...
ActiveRecord::Schema[8.1].define(version: 2026_08_10_060059) do
  ...
  create_enum "user_role_enum", ["admin", "volunteer"]
  ...
  create_table "event_organizers", force: :cascade do |t|
    t.datetime "created_at", null: false
    t.bigint "event_id", null: false
    t.enum "role", default: "shift_lead", null: false, enum_type: "event_organizer_enum"
    t.datetime "updated_at", null: false
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.string "phone"
    t.enum "role", default: "volunteer", null: false, enum_type: "user_role_enum"
    t.datetime "updated_at", null: false
  ...
  add_foreign_key "events", "users", column: "created_by_id", on_delete: :nullify
  add_foreign_key "oauth_credentials", "users"
  add_foreign_key "shifts", "activities"
  add_foreign_key "shifts", "users", column: "shift_lead_id", on_delete: :nullify
