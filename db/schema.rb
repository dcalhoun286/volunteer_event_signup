...
ActiveRecord::Schema[8.1].define(version: 2026_08_09_192436) do
  # These are extensions that must be enabled in order to support this database
  enable_extension "pg_catalog.plpgsql"

  # Custom types defined in this database.
  # Note that some types may not work with other database engines. Be careful if changing database.
  create_enum "event_organizer_permission_enum", ["organizer", "shift_lead"]
  ...
  create_table "event_organizers", force: :cascade do |t|
    t.datetime "created_at", null: false
    t.bigint "event_id", null: false
    t.enum "permissions", default: "shift_lead", null: false, enum_type: "event_organizer_permission_enum"
    t.datetime "updated_at", null: false
